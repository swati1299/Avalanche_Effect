...
def main():
    ...
    f = open(r'C:\Users\Dell\Desktop\PA2-main\Diff_Plain.txt')
    lines = f.readlines()
    ...
    f = open(r'C:\Users\Dell\Desktop\PA2-main\diff_hammingDistance.txt')
    lines = f.readlines()
    ...
    f = open(r'C:\Users\Dell\Desktop\PA2-main\diff_keys.txt')
    lines = f.readlines()
